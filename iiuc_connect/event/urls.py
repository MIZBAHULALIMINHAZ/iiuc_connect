...
from .views import EndEventView, EventEditView, EventViewSet, EventRegistrationViewSet, EventPaymentViewSet, GuestEventDetailView, GuestEventListView, GuestLoginView, GuestRegisterView
...
urlpatterns = [
    ...
    path('events/<str:event_id>/end/', EndEventView.as_view(), name="end-event"),
    path('guests/login/', GuestLoginView.as_view(), name="guest-login"),
    path('guests/register/', GuestRegisterView.as_view(), name="guest-register"),
